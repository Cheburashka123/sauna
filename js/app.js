...
window.addEventListener("DOMContentLoaded", function () {
    [].forEach.call(document.querySelectorAll('.forms__form_tel'), function (input) {
        var keyCode;
        function mask(event) {
...
$(document).ready(function () {
    $('.icon-menu, .header__menuLink').click(function (event) {
        $('.header__body,.icon-menu').toggleClass('_active');
